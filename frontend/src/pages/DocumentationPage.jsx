...
const DocumentationPage = ({ user, onNavigate }) => {
    ...
    const submitForReview = async (doc) => {
        ...
        if (result.success) {
            ...
            toast.success('Submission Successful', { description: resubmitted
                ? `Documentation resubmitted for ${targetReviewer} review!`
                : `Documentation submitted for ${targetReviewer} review!` });
